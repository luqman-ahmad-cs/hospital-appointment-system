...
<head>
    ...
    <title>My Prescription — MediCare</title>
    ...
    <style>
        ...
        * { font-family: 'Poppins', sans-serif; }
        ...
        .hospital-name { font-size: 26px; font-weight: 700; }
        .hospital-sub { opacity: 0.8; font-size: 13px; }
        .rx-symbol {
            font-size: 50px; font-weight: 700;
            color: rgba(255,255,255,0.3); font-style: italic;
        }
        .doctor-info {
            background: #e3f2fd; padding: 15px 40px;
        ...
        .info-value { font-weight: 700; color: #333; font-size: 15px; }
        .diagnosis-box {
        ...
        .med-table { width: 100%; border-collapse: collapse; margin-bottom: 25px; }
        .med-table th { background: #0d6efd; color: white; padding: 12px 15px; font-size: 13px; }
        .med-table td { padding: 12px 15px; font-size: 14px; border-bottom: 1px solid #e0e0e0; }
        ...
        .signature-box {
            ...
            padding-top: 20px; border-top: 2px solid #e0e0e0;
        }
        .signature-line {
            border-top: 2px solid #333; width: 200px;
            margin-left: auto; margin-bottom: 5px;
        }
        .pres-footer {
            background: #f8f9fa; padding: 15px 40px;
            text-align: center; border-top: 2px solid #e0e0e0;
        ...
        @media print {
            ...
            .prescription { box-shadow: none; border-radius: 0; }
        }
    </style>
</head>
<body>
...
<div class="prescription">
    ...
    <div class="doctor-info">
        <div class="row">
            <div class="col-md-6">
                <strong>Dr. <?php echo $pres['doctor_name']; ?></strong>
    ...
    <div class="pres-body">
        ...
        <table class="med-table">
            ...
            <tbody>
                ...
                <tr>
                    <td><span class="med-num"><?php echo $i+1; ?></span></td>
